...
if( !class_exists( 'MV_Slider_Post_Type') ){
    class MV_Slider_Post_Type{
        ...
        public function mv_slider_custom_columns( $column, $post_id ){
            switch( $column ){
                case 'mv_slider_link_text': // If the column is mv_slider_link_text
                    echo esc_html( get_post_meta( $post_id, 'mv_slider_link_text', true ) ); // Display the value of the meta
                break;
