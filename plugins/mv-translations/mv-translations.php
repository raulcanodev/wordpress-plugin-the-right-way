...
if( !class_exists( 'MV_Translations' )){
	...
	class MV_Translations{
        ...
        public static function activate(){
            ...
            $mvt_db_version = get_option( 'mv_translations_db_version' );
            ...
            if ( empty( $mvt_db_version ) ){
                $query = "CREATE TABLE $table_name (
                    ...
                    $mvt_db_version = '1.0';
                    add_option( 'mv_translations_db_version', $mvt_db_version );
            }

            // At the time of activation, check if the page exists, if not, create it (null will be true)
        ...
        public function requires(){
            require_once ( MV_TRANSLATIONS_PATH . 'post-types/class.mv-translation-cpt.php' );
        }
